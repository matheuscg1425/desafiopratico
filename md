Este repositório contém a resolução de uma série de exercícios introdutórios de Python, com foco em list comprehension, dict comprehension e manipulação básica de listas, tuplas e dicionários.
